...
- Removed 41 obsolete worktree folders. Git branch and commit objects were checked after removal and retained. The exact paths and revisions are in `Mavis/evidence/checkout-consolidation.json`.
